...
const commentsQ1 = [
  {
    text: "This question was really insightful!",
    comment_by: "alice_wonder",
    comment_time: new Date("2022-01-20T04:00:00"),
  },
];

const commentsQ2 = [
  {
    text: "I've faced this issue before, great to see it here.",
    comment_by: "bob_builder",
    comment_time: new Date("2023-01-11T08:00:00"),
  },
];

const commentsQ3 = [
  {
    text: "More details would make this question stronger.",
    comment_by: "curious_cat",
    comment_time: new Date("2023-02-18T02:00:00"),
  },
];

const commentsQ4 = [
  {
    text: "Interesting use case! Following for more answers.",
    comment_by: "dora_explorer",
    comment_time: new Date("2023-03-10T15:00:00"),
  },
];
